...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-auto w-full bg-slate-900 border-t border-slate-800 text-slate-300 py-8 relative overflow-hidden font-sans print:hidden">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center md:w-1/3 order-3 md:order-2">
            <p className="text-sm font-bold text-blue-100">إعداد / صالح دحمان</p>
            <p className="text-xs text-slate-500 mt-1">رئيس قسم شؤون الموظفين</p>
        </div>
